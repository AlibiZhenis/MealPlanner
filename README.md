# MealPlanner
A project for [Hyperskill's Java Desktop Developer track](https://hyperskill.org/projects/318).
By Alibi Zhenis

# Tech Stack
Tech Stack Used: Java, PostgreSQL, Gradle

# Comments
Ingredient list is saved using 'save' command
